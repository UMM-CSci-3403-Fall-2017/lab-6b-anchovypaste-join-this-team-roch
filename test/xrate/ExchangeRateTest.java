...
public class ExchangeRateTest {
    ...
    @Test
    public void checkUSD20091112() throws IOException, ParserConfigurationException, SAXException, Exception {
    ...
    @Test
    public void checkGBP20100625() throws IOException, ParserConfigurationException, SAXException, Exception {
        ExchangeRateReader xrReader = new ExchangeRateReader(NICS_DUMMY_DATA_URL);
    ...
    @Test
    public void checkCHF20100705() throws IOException, ParserConfigurationException, SAXException, Exception {
        ExchangeRateReader xrReader = new ExchangeRateReader(NICS_DUMMY_DATA_URL);
    ...
    @Test
    public void checkZAR20100909() throws IOException, ParserConfigurationException, SAXException, Exception {
        ExchangeRateReader xrReader = new ExchangeRateReader(NICS_DUMMY_DATA_URL);
    ...
    @Test
    public void checkUSDvsGBP20100625() throws IOException, ParserConfigurationException, SAXException, Exception{
        ExchangeRateReader xrReader = new ExchangeRateReader(NICS_DUMMY_DATA_URL);
    ...
    @Test
    //@Ignore
    public void checkUSDvsGBP20100625online() throws IOException, ParserConfigurationException, SAXException, Exception {
